...
class Loguru:
    ...
    def __init__(self):
        ...
        loguru.logger.add(Config.Paths.DataPath / 'input' / f'test-report.log', rotation='2 MB', enqueue=False, format=self.format, mode='w')
    ...
    def set(self, stock=None):
        ...
        loguru.logger.add(Config.Paths.DataPath / 'input' / stock / f'report.log', rotation='2 MB', enqueue=False, format=self.format, mode='w')
